...
public class Vehiculo implements Serializable {
    ...
    public Vehiculo(int anio, String codigoBarra, ColorVehiculo colorVehiculo, boolean habilitado,
	    ModeloVehiculo modeloVehiculo, String patente, Cliente cliente) {
	this.anio = anio;
