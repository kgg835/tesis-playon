...
public class UsuarioManagedBean implements Serializable {
	...
	try {
	    ...
	    mail.setAsunto("Contrase�a de Playon - Red de plaayas");
	    mail.setDestinatario(usu.getEmail());
	    mail.setMensaje("Estimado: " + usu.getNombre()
		    + " su contrase�a de Playon - Red de playas es la siguiente: " + usu.getPassword());
	    notificador.enviar(mail);
	    FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Se envio correctamente su contrase�a: "
