...
-- ------------------------------------------------------
-- Server version	5.5.17-enterprise-commercial-advanced
...
INSERT INTO `roles_por_usuario` (`rolesPorUsuarioID`, `usuario`, `rolUsuario`) VALUES (1,'pablo_la31','ROLE_ADMIN'),(2,'alejandro','ROLE_ADMIN'),(3,'gonzalo','ROLE_ADMIN'),(4,'gmorales','ROLE_ADMIN'),(5,'eric','ROLE_ADMIN'),(6,'guest','ROLE_CLIENT'),(7,'admin','ROLE_ADMIN');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='ESTADOS:   *Vigente   *Vencida   *Cancelada   *Pendiente   ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `provincia` (`nombre`, `provinciaID`, `paisID`) VALUES ('Cordoba',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Cada instancia representa los datos administrativos de una playa.   ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `playa` (`barrioID`, `cuit`, `disponibilidad`, `domicilio`, `estadoPlayaID`, `nombreComercial`, `latitud`, `longitud`, `razonSocial`, `playaID`, `estadiaID`) VALUES (1,'1',1,'PueyRedon y Velez',1,'Playita',-31.426448,-64.19172,'Playa',1,NULL),(1,'1',2,'Estrada e Ituzaingo',1,'Playon',-31.428205,-64.186356,'Playa2',2,NULL),(1,'1',55,'La Ramada 2771',1,'Casa Ale',-31.376723,-64.217319,'Casa Ale',3,NULL);
...
INSERT INTO `pais` (`nombre`, `paisID`) VALUES ('argentian',1);
...
INSERT INTO `barrio` (`nombre`, `barrioID`, `localidadID`) VALUES ('NuevaCordoba',1,1),('Centro',2,1),('Iponas',3,1),('Alta Cordoba',4,1);
...
INSERT INTO `modelo_vehiculo` (`descripcion`, `nombre`, `modeloVehiculoID`, `marcaVehiculoID`) VALUES (NULL,'Clio',1,1),(NULL,'Fluence',2,1),(NULL,'Ka',3,2),(NULL,'Ranger',4,2),(NULL,'Mondeo',5,2),(NULL,'Amarok',6,3),(NULL,'Vento',7,3),(NULL,'CLC',8,4),(NULL,'Sprinter',9,4),(NULL,'407',10,5),(NULL,'308',11,5),(NULL,'Picasso',14,6),(NULL,'C4',15,6);
...
INSERT INTO `empleado` (`cargoEmpleadoID`, `legajo`, `empleadoID`, `usuarioID`) VALUES (2,1000,8,8),(3,1001,9,2);
...
INSERT INTO `usuario` (`apellido`, `email`, `nombre`, `password`, `sesion`, `usuario`, `usuarioID`, `tipoDocID`, `nroDoc`, `enable`) VALUES ('Moreno','pablo_la31@hotmail.com','Pablo','123456',NULL,'pablo_la31',1,1,'32987654',1),('Bostico','alebostico@hotmail.com','Alejandro','123456',NULL,'alejandro',2,1,'11111111',1),('Arribere','gonzaloarribere@gmail.com','Gonzalo','123456',NULL,'gonzalo',3,1,'22222222',1),('Morales Batovski','morales.batovski@gmail.com','Raúl Gustavo','123456',NULL,'gmorales',4,1,'33333333',1),('Perez Villar','ericperezvillar@gmail.com','Eric','123456',NULL,'eric',5,1,'44444444',1),('Guest','guest@playon.com.ar','Guest','123456',NULL,'guest',6,1,'55555555',1),('Admin','admin@playon.com.ar','Admin','123456',NULL,'admin',7,1,'66666666',1),('Perez','juanperez@hotmail.com','Juan','123456',NULL,'jperez',8,1,'33525412',1),('Santon','santon@hotmail.com','Carlos','123456',NULL,'csanton',9,1,'33525142',1),('Chamot','chamot@hotmail.com','Luciano','123456',NULL,'lchamot',10,1,'22152412',1),('Lopez','lopez@hotmail.com','Maria','123465',NULL,'mlopez',11,1,'12021241',1);
...
INSERT INTO `localidad` (`nombre`, `localidadID`, `provinciaID`) VALUES ('Cordoba',1,1);
...
INSERT INTO `cliente` (`barrioID`, `cuentaClienteID`, `domicilio`, `nroCliente`, `telefono`, `clienteID`, `usuarioID`) VALUES (1,1,'Chile 125',1,'445254',1,9),(1,2,'Ambrosio O. 565',2,'554121',2,10),(2,3,'Chacabuco 525',3,'452212',3,11);
...
-- Dump completed on 2012-07-28 19:22:15
