...
public class Promocion implements Serializable{
	...
	return "Promocion:\t [promocionID= " + id + ", descuento= " + descuento + ", fechaAlta= " + fechaAlta + ", fechaFin= "
		+ fechaFin + ", fechaInicio= " + fechaInicio + ", nombre= " + nombre + ", montoFijo= " + montoFijo
		+ ", " + playa + ", " + tarifa + ", " + estadoPromocion + "]";
    }
