...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src='<c:url value="/resources/script/registration.js"/>'></script>
	...
	<body>
		...
		<center>
		<form:form commandName="user" action="/registracionRolUsuario/add" name="userForm">
