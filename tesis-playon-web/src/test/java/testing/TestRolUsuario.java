...
public class TestRolUsuario {
	...
	List<RolUsuario> roles = rolUsuarioBo.findAll();
	System.out.println("\nRoles:");
	for (RolUsuario rolUsuario2 : roles) {
	    System.out.println(rolUsuario2);
	}
	...
	System.out.println("\nModificado:\t" + rolUsuarioBo.findByNombreRolUsuario("Administrador"));
